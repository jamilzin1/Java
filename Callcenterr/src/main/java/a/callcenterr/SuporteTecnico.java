...
respostaPadrao.add("Você poderia explicar melhor?");
 ...
 public String buscarSolucao(String frase){
 pergunta = palavraChave.textoChave(frase);
 
 for(String value: pergunta){
     if(bancoSolucao.containsKey(value)){
    return bancoSolucao.get(value);
 }
 }
 ...
 public String solucaoPadrao(){
    return respostaPadrao.get(aleatorio.nextInt(9));
 } 
}